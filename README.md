...
Este es un proyecto de ejercicio Back-end desarrollado para Visual Partnership
...
2. Modificar package.json, agregar ruta "test" dependiendo de tu S.O
> "test": "jest" ó "test": "node ./node_modules/.bin/jest"
Revisa la documentacion en: https://jestjs.io/
